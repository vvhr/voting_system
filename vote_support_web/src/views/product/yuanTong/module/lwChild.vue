<template>
  <div class="">
    ...
    <el-dialog title="分包详情" :visible.sync="dialogVisible" width="50%">
      ...
      <div>
      <el-dialog :title="isBoolean === false ? '添加分包队伍' : '修改分包队伍'" :visible.sync="dialogAdd" width="30%" :modal="false">
        <el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm">
          <el-form-item label="分包队伍" prop="content">
            <el-input v-model="ruleForm.fen_team"></el-input>
          </el-form-item>
          <el-form-item label="已支付金额" prop="content">
            <el-input v-model="ruleForm.repay_cost"></el-input>
          </el-form-item>
          <el-form-item label="工程量" prop="content">
            <el-input v-model="ruleForm.work_num"></el-input>
          </el-form-item>
