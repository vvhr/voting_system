...
<script>
  ...
  import { createGoodsExcel, checkGoodsExcel } from '../../api/costGoods'
  ...
  export default {
    ...
    methods: {
      ...
      //   createGoodsExcel(this.ruleForm).then(res => {
      ...
      check(i, length) {
        ...
        this.sleep(150).then(() => {
          // 执行提交
          checkGoodsExcel(this.ruleForm).then(res => {
